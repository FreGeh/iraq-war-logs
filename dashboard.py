...
app.layout = dash.html.Div(className="container", children=[
    ...
    dash.html.Div(className='my-div', children=[
        dash.html.H1('Irak Krieg Visualisierung', className='my-h1'),
        dash.html.P('Aufgrund der großen Datenmenge kann das Laden etwas länger dauern (10-20 Sekunden).', className='my-p'),
        dash.html.H3('Wähle einen der Plots aus:', className='my-h3'),
        dash.dcc.Tabs(id='tabs-example', value='plot1', className='my-tabs', children=[
            dash.dcc.Tab(label='Plot 1', value='plot1', className='my-tab'),
            dash.dcc.Tab(label='Plot 2', value='plot2', className='my-tab'),
            dash.dcc.Tab(label='Plot 3', value='plot3', className='my-tab'),
            dash.dcc.Tab(label='Plot 4', value='plot4', className='my-tab'),
            dash.dcc.Tab(label='Plot 5', value='plot5', className='my-tab'),
        ]),
    ]),
